...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-lawflow-which-captures-lawyers-end-to-end-thought-processes-is-accepted-to-colm-2025-see-you-in-montreal",
          title: '✅ LawFlow, which captures lawyers’ end-to-end thought processes, is accepted to COLM 2025!...',
          description: "",
